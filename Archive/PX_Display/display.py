...
def display(name):
    if name == "Jurong":
        return render_template('customer_display.html',name=name, displayc1=displayc1J,counter1missed=counter1Jmissed, 
                           displayc2=displayc2J,counter2missed=counter2Jmissed,
                           displayc3=displayc3J,counter3missed=counter3Jmissed,
                           queueinline1=queueinline1J,queueinline2=queueinline2J,queueinline3=queueinline3J, counter1total = counter1totalJ,
                           counter2total = counter2totalJ,counter3total = counter3totalJ)
    if name == "Changi":
        return render_template('customer_display.html',name=name, displayc1=displayc1C,counter1missed=counter1Cmissed, 
                           displayc2=displayc2C,counter2missed=counter2Cmissed,
                           displayc3=displayc3C,counter3missed=counter3Cmissed,
                           queueinline1=queueinline1C,queueinline2=queueinline2C,queueinline3=queueinline3C, counter1total = counter1totalC,
                           counter2total = counter2totalC,counter3total = counter3totalC)
    
    if name == "Yishun":
        return render_template('customer_display.html',name=name, displayc1=displayc1Y,counter1missed=counter1Ymissed, 
                           displayc2=displayc2Y,counter2missed=counter2Ymissed,
                           displayc3=displayc3Y,counter3missed=counter3Ymissed,
                           queueinline1=queueinline1Y,queueinline2=queueinline2Y,queueinline3=queueinline3Y, counter1total = counter1totalY,
